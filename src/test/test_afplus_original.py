...
if os.path.exists("results/afplus") == False:
    os.mkdir("results/afplus")
...
for scenario in scenarioius:
    ...
    fig.savefig(
        "results/afplus/afplus_orig_" + scenario + "_v2.png", bbox_inches="tight"
    )
    plt.close(fig)
...
# save metrics
torch.save(metrics_all, "results/afplus/afplus_orig_metrics_v2.pth")
...
metrics_all = torch.load("results/afplus/afplus_orig_metrics_v2.pth")
...
with open("results/afplus/afplus_orig_metrics_v2.tex", "w") as f:
